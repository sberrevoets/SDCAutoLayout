...
- (void)testTopLevelViewThrowsWhenCenteredInSuperView {
	UIView *aView = [[UIView alloc] initWithFrame:CGRectZero];
	XCTAssertThrows([aView sdc_centerInSuperview], @"");
}

- (void)testSubviewDoesNotThrowWhenCenteredInSuperView {
	UIView *aView = [[UIView alloc] initWithFrame:CGRectZero];
	UIView *aParentView = [[UIView alloc] initWithFrame:CGRectZero];
	[aParentView addSubview:aView];
	XCTAssertNoThrow([aView sdc_centerInSuperview], @"");
}
